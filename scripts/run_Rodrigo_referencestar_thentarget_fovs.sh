...
CUDA_VISIBLE_DEVICES=0 python run_JWST_current_smaller_FOV.py \
    ...
    --scene_name REAL_DATA_SMOOTH \
    --exp_name reference_TWA_diffinitconds_ttv\
    --iters 1500 \
    --star_offset_x 0.4 --star_offset_y -0.8 \
    --oversample 2 --num_wl 21 --num_det_px 80 --num_ints 2 --lr 0.00000003 --smooth 0.6 #--use_simulated_data  #--lr 0.00000003 #--smooth 0.6 #--use_linear_interp_opd  # --OPD_loss_weight 1 --use_ptt