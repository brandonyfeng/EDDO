...
#SBATCH --job-name=yes  ## When you run squeue -u NETID this is how you can identify the job
...
CUDA_VISIBLE_DEVICES=0 python run_JWST_current_smaller_FOV_decenter_tryincnoise.py \
        ...
        --scene_name HR8799_ref_only_NEWDISPERSION\
        --px_mask_file REF-HD220657_original/pixel_masks.npy \
        --ref_which_int 0 --sci_which_int 0 \
        --exp_name ref1_dith1_int0\
        --iters 3000 --sci_targ_name HR8799 --ref_cutoff_iter 30000 \
