...
#SBATCH --job-name=ohno2  ## When you run squeue -u NETID this is how you can identify the job
...
CUDA_VISIBLE_DEVICES=0 python run_JWST_LATEST_twodeltawfes_trackinjected_many_stop.py \
        ...
        --iters 3000 --sci_targ_name HIP65426 --ref_cutoff_iter 600 --sci_lr_weight 0.3 \
        ...
        --inject_how_many_random 20 --inject_how_many_sigma_flux 25 --measurement_noisemap noise_maps/noisemap_target_002_00001.npy \
